...
class SVGPort extends Port
{
	...
	function StartPicture($centre = false)
	{
		...
		{
			// using viewBox means we can scale the diagram automatically using CSS
			// https://stackoverflow.com/a/63038791
			// https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/viewBox
			$svg->setAttribute('viewbox', 	'0 0 ' . $this->width . ' ' . ($this->height - $this->font_size));
			
			// means we can stretch the diagram vertically without increasing the width
			// https://stackoverflow.com/a/44846135
			$svg->setAttribute('preserveAspectRatio', 	'none');
		}
		
		$svg = $this->document->appendChild($svg);

		if (0) // don't have style if SVG is embedded in HTML and we want to change CSS
		{
